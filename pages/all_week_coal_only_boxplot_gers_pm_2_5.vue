      ...
      <v-row dense>
        ...
        >
          <v-card>
            ...
            <div>
              <p>Coal Only Modified Gers = ['OH']</p>
              <p>Stats: </p>
              <p>whiskers:  [118.0, 316.0, 118.0, 351.0, 21.0, 379.0, 26.0, 362.0, 45.0, 325.0, 44.0, 316.0, 45.0, 312.0]</p>
              <p>caps:  [118.0, 316.0, 118.0, 351.0, 21.0, 379.0, 26.0, 362.0, 45.0, 325.0, 44.0, 316.0, 45.0, 312.0]</p>
              <p>boxes:  [156.0, 156.0, 154.0, 152.0, 150.0, 146.0, 145.0]</p>
              <p>medians:  [176.0, 178.0, 178.0, 175.0, 171.0, 167.0, 165.0]</p>
              <p>means:  [215.5163188871054, 217.0013458950202, 237.31849348140994, 229.36388300127172, 221.19312429165092, 212.64646946564886, 208.63344091360477]</p>
              <p>fliers:  []</p>
            </div>
          </v-card>
        </v-col>
