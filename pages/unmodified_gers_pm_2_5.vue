...
<!-- 
    ...
    >
      ...
      <v-toolbar-title>Unmodified Gers PM 2.5 Daily Trend Graphs</v-toolbar-title>
...
<script>
  export default {
    data: () => ({
      ...
      // ],
      sensors: ['AB', 'MB', 'NL', 'NS', 'NU', 'OK', 'PA', 'RI', 'SD', 'UT', 'VA', 'WI', 'WY']
    }),
    computed: {
      cards: function () {
        let allSensors = []
        for (const sensor of this.sensors) {
          allSensors.push(
            { title: sensor, src: 'https://raw.githubusercontent.com/ylehilds/analyzing-mongolia-air-quality/master/jupyter/unmodified_gers_pm_2_5/'+sensor+'_pm_2_5.png', flex: 50 }
          )
        }
        return allSensors
      },
