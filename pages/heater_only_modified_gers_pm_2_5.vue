...
<!-- 
    ...
    >
      ...
      <v-toolbar-title>Heater Only Modified Gers PM 2.5 Daily Trend Graphs</v-toolbar-title>
    ...
    computed: {
      cards: function () {
        ...
        for (const sensor of this.sensors) {
          allSensors.push(
            { title: sensor, src: 'https://raw.githubusercontent.com/ylehilds/analyzing-mongolia-air-quality/master/jupyter/heater_only_modified_gers_pm_2_5/'+sensor+'_pm_2_5.png', flex: 50 }
          )
        }
        return allSensors
      },
