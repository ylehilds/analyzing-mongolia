    ...
    computed: {
      cards: function () {
        ...
        for (const sensor of this.sensors) {
          allSensors.push(
            { title: sensor, src: 'https://raw.githubusercontent.com/ylehilds/analyzing-mongolia-air-quality/master/jupyter/modified_gers_pm_2_5/'+sensor+'_pm_2_5.png', flex: 50 }
          )
        }
        return allSensors
      },
