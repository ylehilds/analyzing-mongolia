...
<!-- 
    ...
    >
      ...
      <v-toolbar-title>Hybrid Modified Gers PM 2.5 Daily Trend Graphs</v-toolbar-title>
...
<script>
  export default {
    data: () => ({
      ...
      // ],
      sensors: ['AK', 'AL', 'AR', 'AZ', 'CA', 'CO', 'CT', 'DE', 'FL', 'IA', 'KS', 'KY', 'LA', 'MD', 'ME', 'MI', 'MN', 'MS', 'MT', 'NC', 'NH']
    }),
    computed: {
      cards: function () {
        let allSensors = []
        for (const sensor of this.sensors) {
          allSensors.push(
            { title: sensor, src: 'https://raw.githubusercontent.com/ylehilds/analyzing-mongolia-air-quality/master/jupyter/hybrid_modified_gers_pm_2_5/'+sensor+'_pm_2_5.png', flex: 50 }
          )
        }
        return allSensors
      },
